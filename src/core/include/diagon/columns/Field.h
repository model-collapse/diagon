...
class Field {
public:
    using FieldVariant = std::variant<std::monostate,  // NULL/Nothing
                                      uint64_t,        // UInt64
                                      int64_t,         // Int64
                                      float,           // Float32
                                      double,          // Float64
    ...
    bool operator==(const Field& rhs) const { return value_ == rhs.value_; }
    ...
    const FieldVariant& getValue() const { return value_; }
